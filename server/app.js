...
app.use("/api/recruiter/auth", require("./routes/Recruiter Api/recruiterCredential"));
...
app.use("/api/recruiter/details", require("./routes/Recruiter Api/recruiterDetails"));
