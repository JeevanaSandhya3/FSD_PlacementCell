...
const Profile = () => {
        ...
        if (response.data.success) {
          ...
          dispatch(
            setUserData({
              ...
              mobileNumber: response.data.user[0].officialEmail,
  ...
  const checkPasswordHandler = (e) => {
    ...
    axios
      .post(
        `${baseApiURL()}/recruiter/auth/login`,
  ...
  const changePasswordHandler = (id) => {
    ...
    axios
      .post(
        `${baseApiURL()}/recruiter/auth/update/${id}`,
          ...
          <div>
            <p className="text-2xl font-semibold">
              ...
              <p className="text-lg font-normal mb-2">
                Phone Number: +91 {data.mobileNumber}
              </p>
              <p className="text-lg font-normal mb-2">
                Email Address: {data.officialEmail}
              </p>
              <p className="text-lg font-normal mb-2">
                About: {data.about}
              </p>
